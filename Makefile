...
kernel.bin: $B/kernel_entry.o $K/kernel.o $K/idt.o $K/pic.o $D/keyboard.o $K/allocator.o $K/pmm.o $K/vmm.o $K/gdt.o $K/proc.o $L/string.o $L/vector.o
	$(LD) $(LD_FLAGS) $B/kernel_entry.o $K/kernel.o $K/idt.o $K/pic.o $D/keyboard.o $K/allocator.o $K/pmm.o $K/vmm.o $K/gdt.o $K/proc.o $L/string.o $L/vector.o -o kernel.bin
